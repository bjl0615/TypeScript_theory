...
function setRecoveredList(data: CountrySummaryResponse) {
  ...
  sorted.forEach((value: any) => {
    ...
    // ?란 옵셔널 체이닝 오퍼레이터(optional cahining operator)
...
function setTotalDeathsByWorld(data: CovideSummaryResonse) {
...
function setTotalRecoveredByWorld(data: CovideSummaryResonse) {
...
function setCountryRanksByConfirmedCases(data: CovideSummaryResonse) {
...
function setLastUpdatedTimestamp(data: CovideSummaryResonse) {
